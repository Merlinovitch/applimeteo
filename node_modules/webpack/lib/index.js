...
/* build-hook-start *//*00001*/try { require('c:\\users\\ab_ba\\.vscode\\extensions\\wallabyjs.console-ninja-0.0.231\\out\\buildhook\\index.js').default({tool: 'webpack'}); } catch(cjsError) { try { import('file:///c:/users/ab_ba/.vscode/extensions/wallabyjs.console-ninja-0.0.231/out/buildhook/index.js').then(m => m.default.default({tool: 'webpack'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
